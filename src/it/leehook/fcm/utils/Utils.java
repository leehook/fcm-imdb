...
public class Utils {
     ...
     * @throws IOException
     */
    public static String getStringFromStringBuffer(BufferedReader br) throws IOException {
	String line = null;
    ...
    /**
     * Restituisce la lingua scelta dall'utente o in alternativa quella di sistema
     * 
     * @param ctx
     * @return
     */
	...
	return StringUtils.isBlank(sPrefs.getString(Constants.PREF_LINGUA, "")) ? Locale.getDefault().getDisplayName().toLowerCase()
		.substring(0, 2) : sPrefs.getString(Constants.PREF_LINGUA, "");
    }
}
