...
public class Constants {
    ...
    public static final String TABLE_CUP = "coppa";
    ...
    public static final String DEFAULT_VOTI = "http://www.pianetafantacalcio.it/Voti_Ufficiosi.asp?TipoVoti=M";
    public static final String DEFAULT_ASSIST = "http://www.gazzetta.it/calcio/fantanews/assist/serie-a-2015-16";
    public static final String DEFAULT_LIVE = "http://www.fantagazzetta.com/voti-live-serie-A";
    ...
    public static final String IMG_PATH = Environment.getExternalStorageDirectory().getPath() + "/IMDB/img/";
    ...
    public static final String PREF_VOTI_UFF = "votiEdit";
    public static final String PREF_ASSIST = "assistEdit";
    public static final String PREF_LIVE = "liveEdit";
    ...
    public static final String COMP_PREFIX = "var xc";
