...
public class Lega extends Activity {
	...
	if (sPrefs.getBoolean(Constants.PREF_COPPA, true)) {
		...
		public void onClick(View v) {
		    ...
		    builder.setPositiveButton(getString(R.string.campionato), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
			    startCampionato();
			}
		    }).setNegativeButton(getString(R.string.coppa), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
			    startCoppa();
			}
		    });
