...
public class SquadreAdapter extends BaseAdapter implements Filterable {
	...
	match = Typeface.createFromAsset(context.getAssets(), "fonts/candles.ttf");
	this.list = myList;
    }
	...
	res.nomeAllenatore = (TextView) convertView.findViewById(R.id.nomeAllenatore);
	res.nomeAllenatore.setText(squadra.getNomeAllenatore());
	res.nomeAllenatore.setTextColor(Color.LTGRAY);
	res.mailAllenatore = (TextView) convertView.findViewById(R.id.mailAllenatore);
	res.mailAllenatore.setText(squadra.getMailAllenatore());
	res.mailAllenatore.setTextColor(Color.LTGRAY);
	res.creditiAllenatore = (TextView) convertView.findViewById(R.id.creditiAllenatore);
	...
	convertView.setOnClickListener(new View.OnClickListener() {
		...
		rosa.setAdapter(new RosaAdapter(dialog.getContext(), squadra.getRosa()));
		dialog.show();
	    }
	});
